...
function StudentDashboard() {
  return (
    <Layout>
    <div className="min-h-screen p-6 bg-gradient-to-br from-green-200 to-green-200 text-gray-800">
      <div className="max-w-4xl mx-auto bg-yellow-100 shadow-lg rounded-2xl p-6">
        <h1 className="text-3xl font-bold mb-4 text-red-500">Panel del Estudiante</h1>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-red-500 p-4 rounded-2xl shadow">
            <h2 className="text-xl font-semibold text-sky-100 text-center">Módulo 1</h2>
            <p className="text-sky-200">Funcionalidad relacionada.</p>
          </div>
          <div className="bg-red-500 p-4 rounded-2xl shadow">
            <h2 className="text-xl font-semibold text-sky-100 text-center">Módulo 2</h2>
            <p className="text-sky-200">Otra funcionalidad.</p>
          </div>
        </div>
      </div>
    </div>
